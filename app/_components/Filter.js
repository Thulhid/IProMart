...
//     searchParamsToReset?.forEach(
//       (param) => searchParams.set(param.name, param.value) // update the object in memory
//     );
//     setSearchParams(searchParams); // actually updates the browser URL
//   }
